################################################################################
# I made changes to this package, that's why I changed the package version
# The changes are maily on the display or nor of the principal axes
# 7 Dez 2006 - nunolf
################################################################################

package provide Orient 1.01
package require La
...
proc vmd_draw_principalaxes { mol sel {weights domass} } {
	...
	# I have commented these lines to not draw the principal axes
